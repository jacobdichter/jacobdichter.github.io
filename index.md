...
<img src="{{ '/assets/Microsoft_Visual_Basic_for_Applications_logo1.png' | absolute_url }}" alt="VBA" width="22.01" height="16.11" style="transform: translateY(2px); margin-right:4px;">VBA&nbsp;&nbsp;
